...
<head>
  ...
  <meta name="description" content="DMT Cricket - <?= $isEditMode ? 'Edit' : 'Create' ?> Product" />
  ...
  <!-- Title -->
  <title><?= $isEditMode ? 'Edit' : 'Create' ?> Product | DMT Cricket - Admin Dashboard</title>
        ...
        <div class="edash-content-breadcumb row mb-4 mb-md-6 pt-md-2 px-4">
          <div class="col-12">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                <h2 class="h4 fw-semibold text-dark">Create New Product</h2>
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                      <button type="submit" class="btn btn-primary">
                        <i class="fi fi-rr-check me-2"></i><?= $isEditMode ? 'Update Product' : 'Create Product' ?>
                      </button>
                      <a href="/admin/products" class="btn btn-outline-secondary">
    ...
    function confirmCreate() {
      ...
      performValidation().then(() => {
        ...
        Swal.fire({
          ...
          text: 'Are you sure you want to create this new product? Please review all information before proceeding.',
          icon: 'question',
          ...
          if (result.isConfirmed) {
            ...
            const form = document.querySelector('form[onsubmit*="confirmCreate"]');
