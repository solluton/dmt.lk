<!-- Blog Pages Footer (with ../ paths for slug URLs) -->
<section class="section footer">
  <div class="container">
    <div class="footer-content">
      <div data-w-id="e66f247d-44b3-1cc7-b84b-ae0ea672d4b3" class="footer-details-menu-wrapper">
        <div class="footer-details">
          <a href="../index" class="footer-logo-link w-inline-block"><img src="../images/logo-neomed.svg" loading="lazy" alt="" class="footer-logo-image"></a>
          ...
          <div class="footer-social-media-wrapper">
            ...
            <a href="https://facebook.com/" target="_blank" class="footer-social-media-link w-inline-block">
              <div class="footer-social-media-icon"></div>
            </a>
            <a href="https://twitter.com/" target="_blank" class="footer-social-media-link w-inline-block">
              <div class="footer-social-media-icon"></div>
            </a>
            <a href="https://instagram.com/" target="_blank" class="footer-social-media-link w-inline-block">
              <div class="footer-social-media-icon"></div>
            </a>
          </div>
        </div>
        <div class="footer-menu-wrapper">
          ...
          <div class="footer-menu-single">
            ...
            <div class="footer-menu-list-wrapper">
              <ul role="list" class="footer-menu-list">
                <li class="footer-menu-list-item">
                  <a href="../index" class="footer-menu-text-link">Home</a>
                </li>
                <li class="footer-menu-list-item">
                ...
                <li class="footer-menu-list-item">
                  <a href="../quality-assurance" class="footer-menu-text-link">Quality Asurrance</a>
                </li>
                <li class="footer-menu-list-item">
